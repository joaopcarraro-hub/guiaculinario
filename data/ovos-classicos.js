...
window.RECIPES["ovos-classicos"] = [
  ...
  // ===================== FAMÍLIA BENEDICT =====================
  {
    ...
    tags: ["protein:ovo", "contains:suino", "ingredient:ovo", "course:cafe-da-manha"],
    ingredients: [
  ...
  },
  {
    ...
    yield: "2 porções (4 unidades)",
    difficulty: "Média-alta",
    tags: ["protein:ovo", "diet:vegetariana", "ingredient:ovo", "ingredient:espinafre", "course:cafe-da-manha"],
    ingredients: [
      "2 English muffins, cortados ao meio",
  ...
  },
  {
    ...
    yield: "2 porções (4 unidades)",
    difficulty: "Média-alta",
    tags: ["protein:ovo", "contains:peixe", "ingredient:ovo", "course:cafe-da-manha"],
    ingredients: [
      "2 English muffins, cortados ao meio",
  ...
  },
  {
    ...
    yield: "2-3 porções",
    difficulty: "Fácil",
    tags: ["protein:ovo", "diet:vegetariana", "ingredient:ovo", "ingredient:tomate", "ingredient:pimentao", "course:cafe-da-manha"],
    ingredients: [
  ...
  },
  {
    ...
    yield: "2 porções",
    difficulty: "Fácil",
    tags: ["protein:ovo", "diet:vegetariana", "ingredient:ovo", "ingredient:tomate", "ingredient:milho", "ingredient:feijao", "ingredient:queijo", "course:cafe-da-manha"],
    ingredients: [
  ...
  // ===================== OVOS FRIOS E ESPECIAIS =====================
  {
    ...
    yield: "2 porções (4 unidades)",
    difficulty: "Fácil",
    tags: ["protein:ovo", "diet:vegetariana", "ingredient:ovo", "course:entrada"],
    ingredients: [
  ...
  },
  {
    ...
    yield: "4 unidades",
    difficulty: "Média",
    tags: ["protein:ovo", "contains:suino", "ingredient:ovo", "course:entrada"],
    ingredients: [
