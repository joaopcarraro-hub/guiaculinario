...
function main() {
  ...
  console.log("==================================================");
  assert(/const CACHE_NAME = "cardapio-v56";/.test(swJs), "CACHE_NAME v49 -> ... -> v55 -> v56 (hotfix timer-lifecycle 2026-07-31: bump de outra feature, atualizado pro valor vigente)");
