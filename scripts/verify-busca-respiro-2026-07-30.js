...
function main() {
  ...
  console.log("==================================================");
  assert(/const CACHE_NAME = "cardapio-v57";/.test(swJs), "CACHE_NAME v49 -> ... -> v56 -> v57 (coleções abstratas de tempo/dificuldade ilustradas, 2026-07-31: bump de outra feature, atualizado pro valor vigente)");
