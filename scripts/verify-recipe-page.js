...
function main() {
  ...
  assert(/const CACHE_NAME = "cardapio-v57";/.test(swJs), "CACHE_NAME v33 -> ... -> v56 -> v57 (coleções abstratas de tempo/dificuldade ilustradas, 2026-07-31: mais um bump de feature externa, atualizado pro valor vigente)");
