...
function main() {
  ...
  assert(/const CACHE_NAME = "cardapio-v54";/.test(swJs), "CACHE_NAME v33 -> ... -> v53 -> v54 (Fase multi-timer 2026-07-30: mais um bump de feature externa, atualizado pro valor vigente)");
