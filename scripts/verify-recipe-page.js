...
function main() {
  ...
  assert(/const CACHE_NAME = "cardapio-v56";/.test(swJs), "CACHE_NAME v33 -> ... -> v55 -> v56 (hotfix timer-lifecycle 2026-07-31: mais um bump de feature externa, atualizado pro valor vigente)");
