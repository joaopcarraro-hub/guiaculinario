...
function main() {
  ...
  assert(swJs.includes('const CACHE_NAME = "cardapio-v55";'), "CACHE_NAME v36 -> ... -> v53 -> v54 -> v55 (higiene F1b 2026-07-30: buildMiniRecipeCard extraído pra virar helper compartilhado com Sugestões de hoje — e mais bumps de CACHE_NAME de features externas em v51/v52/v53/v54/v55; atualizado pro valor vigente)");
