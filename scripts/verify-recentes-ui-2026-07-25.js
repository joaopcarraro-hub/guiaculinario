...
function main() {
  ...
  assert(swJs.includes('const CACHE_NAME = "cardapio-v54";'), "CACHE_NAME v36 -> ... -> v52 -> v53 -> v54 (higiene F1b 2026-07-30: buildMiniRecipeCard extraído pra virar helper compartilhado com Sugestões de hoje — e mais bumps de CACHE_NAME de features externas em v51/v52/v53/v54; atualizado pro valor vigente)");
