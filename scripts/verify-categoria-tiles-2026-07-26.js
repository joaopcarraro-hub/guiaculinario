...
function main() {
  ...
  assert(swJs.includes('const CACHE_NAME = "cardapio-v52";'), "CACHE_NAME v36 -> ... -> v51 -> v52 (corte de natureza 2026-07-30: mais um bump de feature externa, atualizado pro valor vigente)");
