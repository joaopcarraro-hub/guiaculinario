...
function main() {
  ...
  assert(swJs.includes('const CACHE_NAME = "cardapio-v54";'), "CACHE_NAME v36 -> ... -> v53 -> v54 (Fase multi-timer 2026-07-30: mais um bump de feature externa, atualizado pro valor vigente)");
