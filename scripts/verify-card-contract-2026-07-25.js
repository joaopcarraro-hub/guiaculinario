...
function main() {
  ...
  assert(swJs.includes('const CACHE_NAME = "cardapio-v55";'), "CACHE_NAME v36 -> ... -> v54 -> v55 (Fase indicadores 2026-07-30: mais um bump de feature externa, atualizado pro valor vigente)");
