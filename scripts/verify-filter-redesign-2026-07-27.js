...
function main() {
  ...
  console.log("==================================================");
  assert(/const CACHE_NAME = "cardapio-v52";/.test(swJs), "CACHE_NAME v35 -> ... -> v51 -> v52 (corte de natureza 2026-07-30: mais um bump de feature externa, atualizado pro valor vigente)");
